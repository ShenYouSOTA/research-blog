...
export const siteConfig = {
  ...
  homepage: {
    sections: [
      ...
      { id: 'latest-posts',    enabled: true, weight: 2, maxItems: 4 },
      { id: 'featured-posts',  enabled: true, weight: 3, maxItems: 4, order: 'shuffle' as 'shuffle' | 'date-desc' | 'date-asc' },
